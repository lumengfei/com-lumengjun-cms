  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent" style="background:#6600FF">
    ...
    <div>
    	<ul class="nav">
    		...
    		<li class="nav-item nav-link"><a href="/user/exit"><font color="red">退出</font></a></li>
    	</ul>
    </div>
  </div>
</nav><!--  头结束 -->
	...
	<div class="container row">
		<div class="col-md-2" style="margin-top:20px ; border-right:solid 2px"> 
			...
			<ul class="nav flex-column">
				  <li class="nav-item">
				    <a class="nav-link active" href="#" onclick="showWork($(this),'/article/articles')" >我的文章</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link" href="#"  onclick="showWork($(this),'/article/postArticle')">发表文章</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link" href="#" onclick="showWork($(this),'/article/comments')" >我的评论</a>
				  </li>
				  <li class="nav-item">
				    <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true"  onclick="showWork('/user/personal')">个人设置</a>
				  </li>
				</ul>	
		</div>
